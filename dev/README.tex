...
Running \textbf{bxBootstrapGuest.sh} will create a fully automated KVM Guest ByStar Platform.
...
\item In the created VM as root:
  ...
  \item install git
  \item pip install bisos.bootstrap
  \item Run xxx to create user bxGenesis and add it to sudoers    
  \end{itemize}
\item In the created VM as bxGenesis run bisos.bootstrap/bin/bxGenWithRepo
